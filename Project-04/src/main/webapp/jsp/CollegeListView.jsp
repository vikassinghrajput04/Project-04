...
<%@page import="com.rays.modal.CollegeModel"%>
<%@page import="com.rays.ctl.CollegeListCtl"%>
	...
	<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
		...
		<center>
			...
			<table width="80%" align="center">
				<tr>
					<td align="center"><label> College Name :</label> <%=HTMLUtility.getList("name", String.valueOf(bean.getId()), l)%>
