...
<%@page import="com.rays.modal.TimetableModel"%>
<%@page import="com.rays.ctl.TimeTableListCtl"%>
...
<form action="<%=ORSView.TIMETABLE_LIST_CTL %>" method="post"> 
	...
	<table width ="100%">
		...
		<input type ="text"  name="Exdate" readonly="readonly" id ="udate5" placeholder="Select Date" value="<%=DataUtility.getDateString(bean.getExamDate()) %>">		
		&nbsp;
