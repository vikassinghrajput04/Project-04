...
<%@page import="com.rays.modal.CourseModel"%>
<%@page import="com.rays.ctl.CourseListCtl"%>
...
<body>
<jsp:useBean id="bean" class="com.rays.beans.CourseBean" scope="request" ></jsp:useBean>
